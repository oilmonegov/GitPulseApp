...
GitPulse provides a REST API for accessing repository analytics, commit data, and user information.

## Authentication

All API requests require authentication via a Bearer token. Include your API token in the `Authorization` header:
...
MARKDOWN,
    ...
    'ui' => [
         ...
         */
        'title' => 'GitPulse API Documentation',
